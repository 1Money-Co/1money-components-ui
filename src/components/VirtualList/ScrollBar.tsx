...
import {
  VIRTUAL_LIST_SCROLLBAR_CSS_VAR,
  VIRTUAL_LIST_SCROLLBAR_DEFAULT_BG,
} from './constants';
...
const ScrollBar = React.forwardRef<ScrollBarRef, ScrollBarProps>((props, ref) => {
  ...
  const visibleTimeoutRef = React.useRef<ReturnType<typeof setTimeout>>(undefined);
  ...
  const thumbStyle: React.CSSProperties = {
    position: 'absolute',
    borderRadius: 99,
    background: `var(${VIRTUAL_LIST_SCROLLBAR_CSS_VAR}, ${VIRTUAL_LIST_SCROLLBAR_DEFAULT_BG})`,
    cursor: 'pointer',
    userSelect: 'none',
  };
