...
export const IllusLocked: FC<IconWrapperProps & IllustrationsCustomProps> = ({ borderColor = DEFAULT_BORDER_COLOR, color = DEFAULT_ALERT_COLOR, gradientColor = DEFAULT_GRADIENT_COLOR, ...rest }) => {
  ...
  const maskId = `illus-locked-mask-${svgId}`;
  ...
  return (
    <IconWrapper viewBox="0 0 74 74" {...rest}>
      ...
      <mask id={maskId} fill="white">
        <path fill="white" d="M39 3C48.9411 3 57 11.0589 57 21V28H65C66.1046 28 67 28.8954 67 30V64C67 65.1046 66.1046 66 65 66H13C11.8954 66 11 65.1046 11 64V30C11 28.8954 11.8954 28 13 28H21V21C21 11.0589 29.0589 3 39 3ZM39 11C33.4772 11 29 15.4772 29 21V28H49V21C49 15.4772 44.5229 11 39 11Z" />
      </mask>
      <path d="M57 28H55.5V29.5H57V28ZM21 28V29.5H22.5V28H21ZM29 28H27.5V29.5H29V28ZM49 28V29.5H50.5V28H49ZM39 3V4.5C48.1127 4.5 55.5 11.8873 55.5 21H57H58.5C58.5 10.2304 49.7696 1.5 39 1.5V3ZM57 21H55.5V28H57H58.5V21H57ZM57 28V29.5H65V28V26.5H57V28ZM65 28V29.5C65.2761 29.5 65.5 29.7239 65.5 30H67H68.5C68.5 28.067 66.933 26.5 65 26.5V28ZM67 30H65.5V64H67H68.5V30H67ZM67 64H65.5C65.5 64.2761 65.2761 64.5 65 64.5V66V67.5C66.933 67.5 68.5 65.933 68.5 64H67ZM65 66V64.5H13V66V67.5H65V66ZM13 66V64.5C12.7239 64.5 12.5 64.2761 12.5 64H11H9.5C9.5 65.933 11.067 67.5 13 67.5V66ZM11 64H12.5V30H11H9.5V64H11ZM11 30H12.5C12.5 29.7239 12.7239 29.5 13 29.5V28V26.5C11.067 26.5 9.5 28.067 9.5 30H11ZM13 28V29.5H21V28V26.5H13V28ZM21 28H22.5V21H21H19.5V28H21ZM21 21H22.5C22.5 11.8873 29.8873 4.5 39 4.5V3V1.5C28.2304 1.5 19.5 10.2304 19.5 21H21ZM39 11V9.5C32.6487 9.5 27.5 14.6487 27.5 21H29H30.5C30.5 16.3056 34.3056 12.5 39 12.5V11ZM29 21H27.5V28H29H30.5V21H29ZM29 28V29.5H49V28V26.5H29V28ZM49 28H50.5V21H49H47.5V28H49ZM49 21H50.5C50.5 14.6487 45.3513 9.5 39 9.5V11V12.5C43.6944 12.5 47.5 16.3056 47.5 21H49Z" fill={lockedBorderColor} mask={`url(#${maskId})`} />
